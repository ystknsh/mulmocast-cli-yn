...
const createMulmoScriptFromUrl = async ({ urls, template_name, outdir, filename, }) => {
    ...
    graph.injectValue("prompt", (0, file_1.readTemplatePrompt)(template_name ?? "seed_materials"));
