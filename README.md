...
| `scratchpad/`    | Temporary files — e.g., audio fragments used to construct final audio       |
| `images/`        | Image files generated by the `images` command                               |
| `cache/`         | Internal cache files for various processing steps                           |
