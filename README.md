...
Optionally, you can specify __clipboard to paste the script from the clipboard, which is generated by other interactive environment such as ChatGPT or Claude.
