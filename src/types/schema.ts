...
export const mulmoReplicateMovieModelSchema = z
  .object({
    ...
    model: z.enum(["bytedance/seedance-1-lite", "kwaivgi/kling-v1.6-pro","kwaivgi/kling-v2.1", "google/veo-2", "google/veo-3", "google/veo-3-fast", "minimax/video-01"]).optional(),
  })
  .strict();
