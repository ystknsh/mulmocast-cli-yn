export const promptTemplates = [
  ...
  },
  {
    ...
    scriptName: "image_prompts_template.json",
    systemPrompt:
      "This script is for YouTube shorts. Another AI will generate comic strips for each beat based on the text description of that beat. Mention the reference in one of beats, if it exists. Use the JSON below as a template.",
